package com.example.androidarchitecture.repository;

import android.app.Application;
import android.os.AsyncTask;

import com.example.androidarchitecture.entity.Note;
import com.example.androidarchitecture.data.NoteDao;
import com.example.androidarchitecture.data.NoteDatabase;
...
public class NoteRepository {
    ...
    public NoteRepository(Application application){
        NoteDatabase database = NoteDatabase.getInstatnce(application);
